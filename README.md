...
\begin{equation}
x =  -\frac{2}{3} + {\left( -\frac{1}{2} + i \sqrt{ 3 } \frac{1}{2} \right)}^{2} \sqrt[3]{ \frac{10}{27} + \sqrt{ 3 } i \frac{1}{3} } +\left( -\frac{1}{2} + i \sqrt{ 3 } \frac{1}{2} \right) \sqrt[3]{ \frac{10}{27} - \frac{1}{3} \sqrt{ 3 } i } \label{eq:1}
\end{equation}
